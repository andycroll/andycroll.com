...
There are multiple aspects to the performance of a typical Rails applications: database queries, view render time, fragment caching and more. There are also considerations for the front-end: image compression, Javascript & CSS size.
