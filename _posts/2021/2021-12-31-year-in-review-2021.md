...
In the end it was as simple as setting an ENV variable in our hosting platform of choice, Heroku. And just like that a bunch of our trialing customers were in the new version. It didn’t explode the business (job one) and all we’ve had to do is manage a bit of support confusion.

![Changing an ENV var](/images/2021/its-that-easy.gif)

It looks as though we’ve fundamentally changed the patterns of sign ups. Before we would see the bulk of customers either sign up in week one, or never. The newer version (even without changing the marketing site and with less onboarding) seems to have a much longer tail of trial conversion and results in the same number of trials.
...
Early in November I finally managed to pin Vaidehi down after contacting her in July about chatting to me about an article about burnout that she wrote. So we’ve agreed to do a “low hassle” podcast where we just have an unplanned, half-hour chat about a work-related topic and then I do the least amount of editing to get it live.
